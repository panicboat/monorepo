...
module Feed
  module Adapters
    ...
    class PostAdapter
      def list_posts_for_cast(cast_id:, limit:, cursor:)
        post_repo.list_by_cast_id(cast_id: cast_id, limit: limit, cursor: cursor)
      end

      def list_public_posts(limit:, cursor:, cast_ids: nil, exclude_cast_ids: nil)
      ...
      def list_all_for_authenticated(public_cast_ids:, followed_cast_ids:, limit:, cursor:, exclude_cast_ids: nil)
      ...
      def list_all_by_cast_ids(cast_ids:, limit:, cursor:, exclude_cast_ids: nil)
        post_repo.list_all_by_cast_ids(
          cast_ids: cast_ids,
          limit: limit,
          cursor: cursor,
          exclude_cast_ids: exclude_cast_ids
