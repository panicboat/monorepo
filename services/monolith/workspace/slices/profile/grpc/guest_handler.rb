...
module Profile
  module Grpc
    class GuestHandler < Handler
      ...
      GuestPresenter = Profile::Presenters::Guest::ProfilePresenter
      GuestDetailPresenter = Profile::Presenters::Guest::DetailPresenter
      SaveProfile = Profile::UseCases::Guest::SaveProfile

      def follow_adapter
        @follow_adapter ||= Profile::Adapters::FollowAdapter.new
      end

      def block_adapter
        @block_adapter ||= Profile::Adapters::BlockAdapter.new
      end
