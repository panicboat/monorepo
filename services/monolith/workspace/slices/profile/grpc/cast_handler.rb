...
module Profile
  module Grpc
    class CastHandler < Handler
      ...
      ProfilePresenter = Profile::Presenters::Cast::ProfilePresenter
      PlanPresenter = Profile::Presenters::Cast::PlanPresenter
      SaveProfile = Profile::UseCases::Cast::Profile::SaveProfile
