  ...
  describe "#call" do
    context "when validation passes and cast exists" do
      ...
      before do
        ...
        allow(repo).to receive(:save_schedules).with(cast_user_id: cast_id, schedules_data: schedules).and_return(saved_schedules)
      end

      it "saves schedules and returns result" do
        result = use_case.call(cast_user_id: cast_id, schedules: schedules)
    ...
    context "when cast does not exist" do
      ...
      it "raises CastNotFoundError" do
        expect { use_case.call(cast_user_id: cast_id, schedules: schedules) }
    ...
    context "when validation fails" do
      ...
      it "raises ValidationError" do
        expect { use_case.call(cast_user_id: cast_id, schedules: invalid_schedules) }
