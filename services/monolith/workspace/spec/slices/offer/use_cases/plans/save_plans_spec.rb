  ...
  describe "#call" do
    context "when validation passes and cast exists" do
      ...
      before do
        ...
        allow(repo).to receive(:save_plans).with(cast_user_id: cast_id, plans_data: plans).and_return(saved_plans)
      end

      it "saves plans and returns result" do
        result = use_case.call(cast_user_id: cast_id, plans: plans)
    ...
    context "when cast does not exist" do
      ...
      it "raises CastNotFoundError" do
        expect { use_case.call(cast_user_id: cast_id, plans: plans) }
    ...
    context "when validation fails" do
      ...
      it "raises ValidationError" do
        expect { use_case.call(cast_user_id: cast_id, plans: invalid_plans) }
