...
RSpec.describe "Profile::Relations::Schedules", type: :database do
  let(:relation) { Hanami.app.slices[:profile]["relations.schedules"] }
  ...
  it "maps to the correct table" do
    # Note: Table in offer schema but still accessed via Profile for read-only operations
