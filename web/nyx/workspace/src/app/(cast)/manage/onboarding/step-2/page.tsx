...
export default function OnboardingStep2() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (images.length < 1) return; // Should be disabled by button state anyway
    console.log("Submitting Photos:", images);
    // TODO: Save to context/local storage
