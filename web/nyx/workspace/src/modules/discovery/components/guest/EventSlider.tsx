...
const events: EventItem[] = [
  {
    id: "1",
    title: "Newcomer Debut",
    subtitle: "Fresh faces this week",
    bg: "bg-gradient-to-r from-pink-500 to-rose-500",
  },
  {
    id: "2",
    title: "Rainy Day Special",
    subtitle: "20% Off all pledges",
    bg: "bg-gradient-to-r from-blue-400 to-cyan-500",
  },
  {
    id: "3",
    title: "Birthday Bash",
    subtitle: "Celebrate Yuna's Bday!",
    bg: "bg-gradient-to-r from-yellow-400 to-orange-500",
  },
  {
    id: "4",
    title: "Late Night",
    subtitle: "Double Trust Points",
    bg: "bg-gradient-to-r from-purple-500 to-indigo-600",
  },
  {
    id: "5",
    title: "Cosplay Week",
    subtitle: "Uniforms & Maid",
...
export const EventSlider = () => {
  return (
    <HorizontalScroll
      ...
      contentClassName="gap-4 pl-4 pr-10 py-6"
    >
      {events.map((evt) => (
        <motion.div
          key={evt.id}
        ...
        >
          <div className="relative z-10 flex h-full flex-col justify-between pointer-events-none select-none">
            <div>
              <span className="inline-block rounded-full bg-white/20 px-3 py-1 text-xs font-bold backdrop-blur-sm tracking-wide">
                EVENT
              </span>
            </div>
            <div>
