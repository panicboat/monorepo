...
const feed: FeedItem[] = [
  {
    id: "1", castId: "1", castName: "Yuna", castImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Yuna",
    content: "Just finished a wonderful ritual! 🕯️ Thank you for the pledge. Tonight I still have 1 slot open at 23:00.",
    time: "10m ago",
    likes: 24, comments: 2
  },
  {
    id: "2", castId: "4", castName: "Mio", castImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Mio",
  ...
  {
    id: "3", castId: "5", castName: "Rin", castImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Rin",
    content: "Rainy days are for deep conversations... ☔ Anyone up for a chat?",
    time: "1h ago",
    likes: 42, comments: 5
  },
  {
    id: "4", castId: "3", castName: "Sarah", castImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah",
    content: "Good morning! ☀️ Starting my shift at 18:00 today. See you soon!",
    time: "4h ago",
    likes: 89, comments: 8
  },
  {
    id: "5", castId: "6", castName: "Kila", castImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Kila",
    content: "Listening to jazz and drinking coffee. Recommendations? ☕",
    time: "5h ago",
    likes: 33, comments: 14
  },
  {
    id: "6", castId: "7", castName: "Elena", castImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Elena",
    content: "Last night was magical. Thanks to everyone who pledged! ✨",
    time: "12h ago",
    likes: 210, comments: 45
  },
  {
    id: "7", castId: "8", castName: "Aoi", castImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Aoi",
...
export const TimelineFeed = () => {
  const [filter, setFilter] = useState<"all" | "following" | "favorites">("all");
  ...
  return (
    <div className="space-y-4 py-4 min-h-screen">
      <div className="px-4 flex items-center justify-between">
        <h2 className="text-lg font-bold font-serif text-slate-800">Timeline</h2>
        ...
        {isLoaded && filteredFeed.length > 0 ? (
          ...
          <div className="py-10 text-center text-slate-400 text-sm">
            {filter === "all" ? "No posts yet." :
              filter === "following" ? "You are not following anyone yet." :
                "No favorites yet."}
          </div>
        )}
      </div>
