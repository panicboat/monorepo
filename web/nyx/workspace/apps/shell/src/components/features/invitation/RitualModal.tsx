...
export const RitualModal: React.FC<RitualModalProps> = ({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <RitualModalContent onClose={onClose} onComplete={onComplete} />
      )}
    </AnimatePresence>
  );
};

interface RitualModalContentProps {
  onClose: () => void;
  onComplete: () => void;
}

const RitualModalContent: React.FC<RitualModalContentProps> = ({ onClose, onComplete }) => {
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8 mt-2">
          <h2 className="text-2xl text-white font-serif-jp mb-2 tracking-wide">
            The Promise
          </h2>
