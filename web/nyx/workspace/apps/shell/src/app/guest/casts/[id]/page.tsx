      ...
      <div className="max-w-md mx-auto relative bg-slate-950 min-h-screen shadow-2xl overflow-hidden">
        ...
        <div className="relative h-[65vh] w-full bg-slate-800 overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center z-10">
            <Link href="/guest/home" className="w-10 h-10 rounded-full bg-black/20 backdrop-blur-md flex items-center justify-center border border-white/10 text-white hover:bg-black/40 transition">
