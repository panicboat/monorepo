    ...
    <nav className="bg-slate-950 border-t border-slate-800 h-16 flex items-center justify-around z-20 pb-safe">
      <Link
        ...
        className={clsx(
          ...
          isActive("/home") ? "text-yellow-500" : "text-slate-500 hover:text-white"
        )}
      >
      ...
      <Link
        ...
        className={clsx(
          "flex flex-col items-center gap-1 w-16 transition",
          isActive("/chats") ? "text-yellow-500" : "text-slate-500 hover:text-white"
        )}
      >
        <div className="relative">
          <MessageSquare className={clsx("w-6 h-6", isActive("/chats") && "fill-yellow-500/20")} />
      ...
      <Link
        ...
        className={clsx(
          "flex flex-col items-center gap-1 w-16 transition",
          isActive("/history") ? "text-yellow-500" : "text-slate-500 hover:text-white"
        )}
      >
