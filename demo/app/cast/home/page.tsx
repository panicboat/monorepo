...
import { MoreHorizontal, Clock, Ticket, MessageCircle, Users, StickyNote } from "lucide-react";
  ...
  return (
    <div className="bg-gray-900 text-slate-200 h-screen font-sans flex justify-center">
      <div className="w-full max-w-md bg-slate-950 h-full relative shadow-2xl flex flex-col">
        {/* Header */}
        <header className="px-5 pt-6 pb-4 bg-slate-950 z-10">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-xl font-bold text-white tracking-wide" style={{ fontFamily: '"Yu Mincho", serif' }}>
              Messages
            </h1>
            ...
            <div className="relative bg-gradient-to-br from-slate-900 to-slate-950 border border-yellow-700/50 rounded-xl p-4 shadow-lg shadow-yellow-900/10 overflow-hidden group">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg text-white font-bold" style={{ fontFamily: '"Yu Mincho", serif' }}>
                    Takuya 様
                  </h3>
              ...
              <div className="mt-4 flex gap-2">
                ...
                <Link href="/cast/chats/user1" className="flex-1 bg-yellow-900/20 hover:bg-yellow-900/30 text-xs text-yellow-500 py-2 rounded-lg border border-yellow-800/50 transition flex items-center justify-center">
                  チャットへ
                </Link>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-slate-900/40 hover:bg-slate-800 border border-slate-800/50 p-3 rounded-xl flex gap-3 cursor-pointer transition">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-center mb-0.5">
                    <div className="flex items-center gap-2">
                      <h3 className="text-sm font-bold text-slate-300">Yuuki</h3>
                    </div>
