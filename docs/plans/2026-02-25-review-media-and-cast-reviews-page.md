...
Run: `cd services/frontend/workspace && npx buf generate ../../../proto`
Expected: フロントエンド用の生成コードが更新される（ConnectRPC クライアント）

**Step 3: コミット**

```bash
git add proto/trust/v1/service.proto services/monolith/workspace/stubs/trust/ services/frontend/workspace/
...
```bash
git add services/frontend/workspace/src/modules/trust/types.ts services/frontend/workspace/src/modules/trust/lib/api-mappers.ts
...
```bash
git add services/frontend/workspace/src/app/api/me/trust/reviews/route.ts
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/trust/components/WriteReviewModal.tsx`
...
```bash
git add services/frontend/workspace/src/modules/trust/components/WriteReviewModal.tsx
...
```bash
git add services/frontend/workspace/src/modules/trust/components/WriteTrustModal.tsx
...
```bash
git add services/frontend/workspace/src/modules/trust/components/ReviewCard.tsx
...
**Files:**
- Create: `services/frontend/workspace/src/app/(cast)/cast/reviews/page.tsx`
- Create: `services/frontend/workspace/src/modules/trust/components/CastReviewsPage.tsx`
...
```bash
git add services/frontend/workspace/src/modules/trust/components/CastReviewsPage.tsx services/frontend/workspace/src/app/\(cast\)/cast/reviews/page.tsx
...
**Files:**
- Modify: `services/frontend/workspace/src/app/(cast)/cast/mypage/page.tsx`
...
```bash
git add services/frontend/workspace/src/app/\(cast\)/cast/mypage/page.tsx
...
検索コマンド: `grep -r "WriteReviewModal\|WriteTrustModal\|onSubmitReview" --include="*.tsx" --include="*.ts" services/frontend/workspace/src/`
