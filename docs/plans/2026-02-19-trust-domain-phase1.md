...
Verify: `services/frontend/workspace/src/stub/trust/v1/service_pb.ts` exists.

**Step 3: Commit**

```bash
git add services/monolith/workspace/stubs/trust/ services/frontend/workspace/src/stub/trust/
...
**Files:**
- Create: `services/frontend/workspace/src/modules/trust/types.ts`
- Create: `services/frontend/workspace/src/modules/trust/index.ts`
- Create: `services/frontend/workspace/src/modules/trust/hooks/index.ts`
- Modify: `services/frontend/workspace/src/lib/grpc.ts` (add trustClient)
...
```bash
git add services/frontend/workspace/src/modules/trust/ services/frontend/workspace/src/lib/grpc.ts
...
**Files:**
- Create: `services/frontend/workspace/src/modules/trust/hooks/useTags.ts`
- Create: `services/frontend/workspace/src/modules/trust/hooks/useTaggings.ts`
...
```bash
git add services/frontend/workspace/src/modules/trust/hooks/
...
**Files:**
- Create: `services/frontend/workspace/src/app/api/me/trust/tags/route.ts`
- Create: `services/frontend/workspace/src/app/api/me/trust/tags/[id]/route.ts`
- Create: `services/frontend/workspace/src/app/api/me/trust/taggings/route.ts`
- Create: `services/frontend/workspace/src/app/api/me/trust/taggings/[id]/route.ts`
...
```bash
git add services/frontend/workspace/src/app/api/me/trust/
...
**Files:**
- Create: `services/frontend/workspace/src/app/api/cast/trust/taggings/pending/route.ts`
- Create: `services/frontend/workspace/src/app/api/cast/trust/taggings/[id]/approve/route.ts`
- Create: `services/frontend/workspace/src/app/api/cast/trust/taggings/[id]/reject/route.ts`
...
```bash
git add services/frontend/workspace/src/app/api/cast/trust/
...
```bash
cd services/frontend/workspace && pnpm tsc --noEmit
```
