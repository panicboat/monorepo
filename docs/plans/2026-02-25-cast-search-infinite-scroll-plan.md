...
**Files:**
- Create: `services/frontend/workspace/src/components/ui/InfiniteScroll.tsx`
...
`services/frontend/workspace/src/components/ui/index.ts` を確認し、必要であれば InfiniteScroll をエクスポートに追加。

**Step 3: Commit**

```bash
git add services/frontend/workspace/src/components/ui/InfiniteScroll.tsx
...
**Files:**
- Create: `services/frontend/workspace/src/modules/portfolio/hooks/useInfiniteCasts.ts`
- Modify: `services/frontend/workspace/src/modules/portfolio/hooks/index.ts`
...
`services/frontend/workspace/src/modules/portfolio/hooks/index.ts` に以下を追加:
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/trust/components/ReviewListPage.tsx`
...
```bash
git add services/frontend/workspace/src/modules/trust/components/ReviewListPage.tsx
...
```bash
git add services/frontend/workspace/src/modules/feed/components/feed/TimelineFeed.tsx
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/feed/components/guest/CastTimeline.tsx`
...
```bash
git add services/frontend/workspace/src/modules/feed/components/guest/CastTimeline.tsx
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/post/components/comments/CommentSection.tsx`
...
```bash
git add services/frontend/workspace/src/modules/post/components/comments/CommentSection.tsx
