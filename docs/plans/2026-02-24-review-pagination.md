...
```bash
git add proto/trust/v1/service.proto services/monolith/workspace/stubs/ services/frontend/workspace/src/stub/
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/trust/types.ts:45-47`
...
```bash
git add services/frontend/workspace/src/modules/trust/types.ts
...
**Files:**
- Modify: `services/frontend/workspace/src/app/api/shared/trust/reviews/route.ts`
...
```bash
git add services/frontend/workspace/src/app/api/shared/trust/reviews/route.ts
...
```bash
git add services/frontend/workspace/src/modules/trust/hooks/useReviews.ts
...
**Files:**
- Create: `services/frontend/workspace/src/modules/trust/hooks/useInfiniteReviews.ts`
- Modify: `services/frontend/workspace/src/modules/trust/hooks/index.ts`
...
```bash
git add services/frontend/workspace/src/modules/trust/hooks/useInfiniteReviews.ts services/frontend/workspace/src/modules/trust/hooks/index.ts
...
**Files:**
- Create: `services/frontend/workspace/src/modules/trust/components/ReviewListPage.tsx`
- Modify: `services/frontend/workspace/src/modules/trust/components/index.ts`
...
```bash
git add services/frontend/workspace/src/modules/trust/components/ReviewListPage.tsx services/frontend/workspace/src/modules/trust/components/index.ts
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/trust/components/TrustSection.tsx`
...
```bash
git add services/frontend/workspace/src/modules/trust/components/TrustSection.tsx
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/trust/index.ts`
...
```bash
git add services/frontend/workspace/src/modules/trust/index.ts
...
**Files:**
- Create: `services/frontend/workspace/src/app/(guest)/casts/[id]/reviews/page.tsx`
...
```bash
git add services/frontend/workspace/src/app/\(guest\)/casts/\[id\]/reviews/page.tsx
...
**Files:**
- Create: `services/frontend/workspace/src/app/(cast)/cast/guests/[id]/reviews/page.tsx`
...
```bash
git add services/frontend/workspace/src/app/\(cast\)/cast/guests/\[id\]/reviews/page.tsx
...
**Files:**
- Modify: `services/frontend/workspace/src/app/(guest)/casts/[id]/page.tsx`
- Modify: `services/frontend/workspace/src/app/(cast)/cast/guests/[id]/page.tsx`
...
```bash
git add services/frontend/workspace/src/app/\(guest\)/casts/\[id\]/page.tsx services/frontend/workspace/src/app/\(cast\)/cast/guests/\[id\]/page.tsx
...
Run: `cd services/frontend/workspace && npm run typecheck`
Expected: No errors
