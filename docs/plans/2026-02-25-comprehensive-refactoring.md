...
**Files:**
- Create: `services/nyx/workspace/src/lib/grpc-errors.ts`
- Create: `services/nyx/workspace/src/lib/api-helpers.ts`

**Step 1: gRPC エラーコード定数を作成**

```typescript
// services/nyx/workspace/src/lib/grpc-errors.ts
...
**Files:**
- Create: `services/nyx/workspace/src/modules/post/lib/api-mappers.ts`
- Modify: `services/nyx/workspace/src/app/api/guest/timeline/route.ts`
- Modify: `services/nyx/workspace/src/app/api/cast/timeline/route.ts`
- Modify: `services/nyx/workspace/src/app/api/feed/guest/route.ts`

**Step 1: Proto → JSON のサーバーサイドマッパーを作成**

```typescript
// services/nyx/workspace/src/modules/post/lib/api-mappers.ts
...
Run: `cd services/nyx/workspace && pnpm lint && pnpm build`
Expected: No errors
...
**Files:**
- Create: `services/nyx/workspace/src/modules/relationship/lib/mappers.ts`
- Modify: `services/nyx/workspace/src/app/api/guest/following/route.ts`
- Modify: `services/nyx/workspace/src/app/api/guest/favorites/route.ts`
- Modify: `services/nyx/workspace/src/app/api/guest/blocks/route.ts`
- Modify: `services/nyx/workspace/src/app/api/cast/blocks/route.ts`
...
**Files:**
- Create: `services/nyx/workspace/src/modules/trust/lib/mappers.ts`
- Modify: `services/nyx/workspace/src/app/api/me/trust/reviews/route.ts`
- Modify: `services/nyx/workspace/src/app/api/shared/trust/reviews/route.ts`（存在する場合）
...
**Files:**
- Delete: `services/nyx/workspace/src/modules/feed/hooks/useGuestFeed.ts`
- Delete: `services/nyx/workspace/src/modules/feed/hooks/useCastFeed.ts`
- Modify: `services/nyx/workspace/src/modules/feed/hooks/index.ts`
...
**Files:**
- Modify: `services/nyx/workspace/src/modules/post/hooks/useCastPosts.ts`
- Read: `services/nyx/workspace/src/modules/post/hooks/useTimeline.ts`（パターン参考）
...
- Modify: `services/nyx/workspace/src/modules/portfolio/lib/cast/mappers.ts`
- Create or modify: `services/nyx/workspace/src/modules/portfolio/types.ts`（API レスポンス型を追加）
