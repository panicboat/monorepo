...
- **File**: `services/frontend/workspace/src/modules/trust/components/ReviewStatsDisplay.tsx`
...
- **File**: `services/frontend/workspace/src/modules/trust/components/TrustSection.tsx`
...
- **File**: `services/frontend/workspace/src/app/(cast)/cast/guests/[id]/page.tsx`
...
**Frontend Changes**:
- **File**: `services/frontend/workspace/src/app/api/shared/trust/reviews/route.ts`
...
**Frontend Changes**:
- **New API Route**: `services/frontend/workspace/src/app/api/cast/guests/[id]/blocked-by/route.ts`
