...
**Files:**
- Modify: `services/frontend/workspace/src/modules/portfolio/types.ts:104-136`
...
```bash
git add services/frontend/workspace/src/modules/portfolio/types.ts
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/portfolio/lib/cast/mappers.ts:1-80`
...
```bash
git add services/frontend/workspace/src/modules/portfolio/lib/cast/mappers.ts
...
**Files:**
- Modify: `services/frontend/workspace/src/app/(cast)/cast/schedules/page.tsx:17-18,70-75`
...
```bash
git add services/frontend/workspace/src/app/(cast)/cast/schedules/page.tsx
...
**Files:**
- Modify: `services/frontend/workspace/src/modules/portfolio/components/cast/ScheduleEditor.tsx:14-28,45-51`
...
```bash
git add services/frontend/workspace/src/modules/portfolio/components/cast/ScheduleEditor.tsx
...
**Files:**
- Create: `services/frontend/workspace/src/modules/portfolio/components/cast/DefaultSchedulesEditor.tsx`
...
Add to `services/frontend/workspace/src/modules/portfolio/components/cast/index.ts`:
...
```bash
git add services/frontend/workspace/src/modules/portfolio/components/cast/DefaultSchedulesEditor.tsx
git add services/frontend/workspace/src/modules/portfolio/components/cast/index.ts
...
```bash
git add services/frontend/workspace/src/modules/portfolio/hooks/useCastProfile.ts
...
Run: `cd services/frontend/workspace && pnpm tsc --noEmit`
