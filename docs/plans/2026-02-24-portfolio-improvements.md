...
**Files:**
- Modify: `services/frontend/workspace/src/modules/trust/components/ReviewStatsDisplay.tsx:3,45`
...
```bash
git add services/frontend/workspace/src/modules/trust/components/ReviewStatsDisplay.tsx
...
**Files:**
- Create: `services/frontend/workspace/src/modules/trust/components/GuestTagsDisplay.tsx`
...
```bash
git add services/frontend/workspace/src/modules/trust/components/GuestTagsDisplay.tsx
git add services/frontend/workspace/src/modules/trust/components/index.ts
...
```bash
git add services/frontend/workspace/src/app/(cast)/cast/guests/[id]/page.tsx
...
**Files:**
- Modify: `services/frontend/workspace/src/app/api/shared/trust/reviews/route.ts:28-36`
...
**Files:**
- Create: `services/frontend/workspace/src/app/api/cast/guests/[id]/blocked-by/route.ts`
...
```bash
git add services/frontend/workspace/src/app/api/cast/guests/[id]/blocked-by/route.ts
...
**Files:**
- Create: `services/frontend/workspace/src/modules/relationship/hooks/useBlockedBy.ts`
...
```bash
git add services/frontend/workspace/src/modules/relationship/hooks/useBlockedBy.ts
git add services/frontend/workspace/src/modules/relationship/hooks/index.ts
