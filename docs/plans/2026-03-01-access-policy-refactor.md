...
**Files:**
- Delete: `services/frontend/workspace/src/modules/relationship/hooks/useFavorite.ts`
- Delete: `services/frontend/workspace/src/app/api/guest/favorites/route.ts`
- Delete: `services/frontend/workspace/src/app/api/guest/favorites/status/route.ts`
- Delete: `services/frontend/workspace/src/app/(guest)/favorites/page.tsx`
- Modify: `services/frontend/workspace/src/modules/relationship/hooks/index.ts`
- Modify: `services/frontend/workspace/src/modules/relationship/types.ts`
- Modify: `services/frontend/workspace/src/stores/socialStore.ts`
- Modify: `services/frontend/workspace/src/modules/feed/types.ts`
- Modify: `services/frontend/workspace/src/modules/feed/components/feed/TimelineFilters.tsx`
...
- Modify: `services/frontend/workspace/src/modules/portfolio/components/guest/GuestDashboard.tsx`

**Step 1: ファイル削除**

```bash
rm services/frontend/workspace/src/modules/relationship/hooks/useFavorite.ts
rm services/frontend/workspace/src/app/api/guest/favorites/route.ts
rm services/frontend/workspace/src/app/api/guest/favorites/status/route.ts
rm services/frontend/workspace/src/app/\(guest\)/favorites/page.tsx
```

favorites ディレクトリが空になった場合は削除:
```bash
rmdir services/frontend/workspace/src/app/api/guest/favorites 2>/dev/null
rmdir services/frontend/workspace/src/app/\(guest\)/favorites 2>/dev/null
```

**Step 2: hooks/index.ts から useFavorite の export 削除**

`services/frontend/workspace/src/modules/relationship/hooks/index.ts` から以下を削除:
```typescript
...
`services/frontend/workspace/src/modules/relationship/types.ts` から以下を削除:
```typescript
...
`services/frontend/workspace/src/stores/socialStore.ts` を修正:
...
`services/frontend/workspace/src/modules/feed/types.ts:6` を修正:
```typescript
// Before:
...
`services/frontend/workspace/src/modules/feed/components/feed/TimelineFilters.tsx` を修正:
...
`services/frontend/workspace/src/app/api/feed/guest/route.ts` を修正:
...
`services/frontend/workspace/src/app/(guest)/casts/[userId]/page.tsx` を修正:
- `useFavorite` の import を削除
- `FavoriteButton` コンポーネントとその使用箇所を削除

**Step 9: GuestDashboard からお気に入りセクション削除**

`services/frontend/workspace/src/modules/portfolio/components/guest/GuestDashboard.tsx` を修正:
- `useFavorite` の import を削除
...
`services/frontend/workspace/src/components/layout/guest/GuestTopNavBar.tsx` から `/favorites` パス検出ロジックを削除（存在する場合）。
...
```bash
cd services/frontend/workspace && pnpm build
```
...
**Files:**
- Delete: `services/frontend/workspace/src/app/api/guest/blocks/route.ts`
- Delete: `services/frontend/workspace/src/app/api/guest/blocks/status/route.ts` (存在する場合)
- Modify: `services/frontend/workspace/src/modules/relationship/hooks/useBlock.ts`
- Modify: `services/frontend/workspace/src/stores/socialStore.ts`
- Modify: `services/frontend/workspace/src/modules/relationship/types.ts`
...
```bash
rm services/frontend/workspace/src/app/api/guest/blocks/route.ts
rm -f services/frontend/workspace/src/app/api/guest/blocks/status/route.ts
rmdir services/frontend/workspace/src/app/api/guest/blocks 2>/dev/null
```

**Step 2: useBlock hook から Guest ブロックロジック削除**

`services/frontend/workspace/src/modules/relationship/hooks/useBlock.ts` を修正:
...
`services/frontend/workspace/src/stores/socialStore.ts` から以下を削除:
...
`services/frontend/workspace/src/modules/relationship/types.ts` を確認:
