...
**Files:**
- Create: `services/frontend/workspace/src/modules/trust/hooks/useReviews.ts`
- Create: `services/frontend/workspace/src/modules/trust/hooks/useReviewStats.ts`
- Create: `services/frontend/workspace/src/modules/trust/hooks/usePendingReviews.ts`
...
**Files:**
- Create: `services/frontend/workspace/src/app/api/me/trust/reviews/route.ts`
- Create: `services/frontend/workspace/src/app/api/me/trust/reviews/[id]/route.ts`
- Create: `services/frontend/workspace/src/app/api/cast/trust/reviews/pending/route.ts`
- Create: `services/frontend/workspace/src/app/api/cast/trust/reviews/[id]/approve/route.ts`
- Create: `services/frontend/workspace/src/app/api/cast/trust/reviews/[id]/reject/route.ts`
- Create: `services/frontend/workspace/src/app/api/shared/trust/reviews/route.ts`
- Create: `services/frontend/workspace/src/app/api/shared/trust/reviews/stats/route.ts`
...
```bash
git add services/frontend/workspace/src/app/api/me/trust/reviews/
git add services/frontend/workspace/src/app/api/cast/trust/reviews/
git add services/frontend/workspace/src/app/api/shared/trust/reviews/
