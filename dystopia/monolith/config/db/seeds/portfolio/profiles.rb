...
profiles_data = [
  { account_id: CAST_USER_IDS[0],  username: "yuna",   display_name: "ゆな",     is_private: false, age: 23, body_stats: { height_cm: 158, cup: "D" }, prefecture: "東京都", industry: "デリヘル" },
  { account_id: CAST_USER_IDS[1],  username: "mio",    display_name: "みお",     is_private: true,  age: 25, body_stats: { height_cm: 162, cup: "C" }, prefecture: "東京都", industry: "ソープ" },
  { account_id: CAST_USER_IDS[2],  username: "rin",    display_name: "りん",     is_private: false, age: 21, body_stats: { height_cm: 155, cup: "E" }, prefecture: "大阪府", industry: "個人" },
...
profiles_data.each do |data|
  ...
  Seeds::Helper.db[:profile__profiles].insert(
    ...
    age: data[:age],
    body_stats: (data[:body_stats] || {}).to_json,
