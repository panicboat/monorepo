...
assert_contains outputs.tf 'output "rds_alias"'
assert_contains outputs.tf 'aws_route53_record.monolith_db.fqdn'
assert_contains route53.tf 'zone_id = aws_route53_zone.dystopia_local.zone_id'
assert_contains route53.tf 'records = [aws_db_instance.monolith.address]'
