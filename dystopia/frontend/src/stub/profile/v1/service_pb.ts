...
export type Profile = Message<"profile.v1.Profile"> & {
   ...
   * 身長/スリーサイズ/カップ
   *
   * @generated from field: profile.v1.BodyStats body_stats = 15;
   */
...
export type SnsLinks = Message<"profile.v1.SnsLinks"> & {
   ...
   * 口コミサイト等の外部リンク
   *
   * @generated from field: string cityheaven = 6;
   */
  cityheaven: string;
};
...
/**
 * @generated from message profile.v1.BodyStats
 */
export type BodyStats = Message<"profile.v1.BodyStats"> & {
  /**
   * @generated from field: int32 height_cm = 1;
   */
  heightCm: number;

  /**
   * @generated from field: int32 bust_cm = 2;
   */
  bustCm: number;

  /**
   * @generated from field: int32 waist_cm = 3;
   */
  waistCm: number;

  /**
   * @generated from field: int32 hip_cm = 4;
   */
  hipCm: number;

  /**
   * @generated from field: string cup = 5;
   */
  cup: string;
};

/**
 * Describes the message profile.v1.BodyStats.
 * Use `create(BodyStatsSchema)` to create a new message.
 */
export const BodyStatsSchema: GenMessage<BodyStats> = /*@__PURE__*/
...
export type SaveProfileRequest = Message<"profile.v1.SaveProfileRequest"> & {
  ...
  /**
   * @generated from field: profile.v1.BodyStats body_stats = 9;
   */
  bodyStats?: BodyStats | undefined;
