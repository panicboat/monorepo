...
remote_state {
  ...
  config = {
    ...
    # Service-specific path: tools/meeting-translation/<environment>/terraform.tfstate
    key    = "tools/meeting-translation/${local.environment}/terraform.tfstate"
